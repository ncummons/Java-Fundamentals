...
public class Exercise_03 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Please input a number between 1 and 12 representing a month of the year: ");
        ...
        switch(month){
            ...
            case 12 :
                ...
                break;
            default :
                System.out.println("The number must be between 1 and 12. Please try running again.");
        }
